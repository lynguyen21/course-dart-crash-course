  ...
  while (true) {
    ...
    switch (option) {
      ...
      case "11":
        ...
        stdout.write("Enter import option: ");
        final importOption = stdin.readLineSync()!;
      ...
      case "12":
        ...
        stdout.write("Enter export option: ");
        final exportOption = stdin.readLineSync()!;

        switch (exportOption) {
          case "1":
            stdout.write("Enter output file path: ");
            final filePath = stdin.readLineSync()!;
